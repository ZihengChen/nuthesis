...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/mc_studies/bmva_mc}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.3\textwidth]{figures/mc_studies/bmva_mceff_vs_pt_b}
    \includegraphics[width=0.3\textwidth]{figures/mc_studies/bmva_mceff_vs_pt_c}
    \includegraphics[width=0.3\textwidth]{figures/mc_studies/bmva_mceff_vs_pt_usdg}
