...
% Calibrations of simulated data are important to account for the potential deviations from the experimental data. Many common calibrations are measured by dedicated groups and shared among CMS analysis. These include the calibrations and corrections mentioned in Section~\ref{sec:analysis:calibration:simulation} and \ref{sec:analysis:selection:object}. 


% This chapter de the major calibrations applied to the simulation. The



% % tau decay
% \subsubsection{$Br(\PGth)$ Reweighting}
...
% \input{chapters/Analysis/sectionDataset/tables/tauBr.tex}
