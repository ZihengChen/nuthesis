...
\begin{table}[!h]
    ...
    \begin{tabular}{ccc|ccc}
        ...
        \hline
        && $R^W_{\rm h/l}$ & $2.060\pm0.021$ & $2.068\pm0.025$ & $2.063\pm0.016$ \\
        \hline
        CKM Unitarity: $\sum_{uc,dsb} |V_{ij}|^2 = 2$ & $\Longrightarrow$ & $\alpha_s(m_W) $ & $0.094\pm0.033$ & $0.108\pm0.040$ & $0.099\pm0.026$  \\%$
        \hline
        PDG~\cite{pdg2020}: $\alpha_s(m_W) = 1.1120\pm0.010$     & $\Longrightarrow$ & $\sum_{\substack{uc\\dsb}} |V_{ij}|^2 $&$ 1.985\pm0.021$ & $1.997\pm0.025$ & $1.992\pm0.016$ \\ %
        \hline
        $\begin{matrix} 
            \text{PDG~\cite{pdg2020}: } \alpha_s(m_W) = 1.1120\pm0.010 \\ 
            \text{PDG~\cite{pdg2020}: } \sum_{\substack{ud,us,ub\\cd,cb}} |V_{ij}|^2 =1.0490(18) \end{matrix} $ 
        & $\Longrightarrow$ & $V_{cs}$ & $ 0.969\pm 0.011$ & $0.974\pm0.013$ & $0.971\pm0.008$ \\
        % PDG: $\alpha_s(m_W) = 1.1120\pm0.010$~\cite{pdg2020}    & \multirow{2}{*}{$\Longrightarrow$} & \multirow{2}{*}{$V_{cs}$ &$ 0.968\pm 0.011$}  \\ %=
        % PDG: $\sum_{\substack{ud,us,ub\\cd,cb}} |V_{ij}|^2 =1.0490(18)$~\cite{pdg2020} & & &\\
        % PDG $\sum_{\substack{uc\\dsb}} |V_{}|^2 + |V_{us}|^2 +|V_{ub}|^2 +|V_{cd}|^2 +|V_{cb}|^2=1.0490(18)$~\cite{pdg2020} & &\\
        \hline
    \end{tabular}
    }
