...
% then summing them in quadrature. As is given in Equation~\ref{eqn:statVar}.
...
% uncertainties in quadrature. As is given in Equation~\ref{eqn:systVar}.
...
% and $\textbf{V}_{syst}$ are shown in Figure~\ref{fig:varStatSyst}.
...
% in Equation~\ref{eqn:DefineChisquared}. 
...
% Equation~\ref{eqn:combineMean} and \ref{eqn:combineCovar} are derived as Equation~7.10 and 7.11
% in Glen Cowan's Statistical Data Analysis.
% With this combining method, the values of average branching 
% fractions are shown in Equation~\ref{eqn:averagebf}. The correlation of 
% $\bar{\beta}_e,\bar{\beta}_\mu, \bar{\beta}_\PGth$ is shown in Figure~\ref{fig:corBetaBar}. 
