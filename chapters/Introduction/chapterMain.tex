...
\begin{table}[!h]
    ...
    \begin{tabular}{ccc}
        ...
        \hline
        PDG $\alpha_s(m_W) = 1.1120\pm0.033$~\cite{pdg2020}     & $\Longrightarrow$ & $\sum_{uc,dsb} |V_{ij}|^2 $ \\ %= 1.985\pm0.021
        \hline
        PDG $\alpha_s(m_W) = 1.1120\pm0.033$~\cite{pdg2020}    & \multirow{2}{*}{$\Longrightarrow$} & \multirow{2}{*}{$V_{cs}$}  \\ %= 0.968\pm 0.011
