...
\input{chapters/Introduction/sectionRelatedWorks/tables/spsTevatron}
...
\input{chapters/Introduction/sectionRelatedWorks/tables/lep}
...
\input{chapters/Introduction/sectionRelatedWorks/tables/meson}
...
% However, these tests require knowledge of the ratio of the form factors of the scalar and vector meson, f0/f+, with very high accuracy to be competitive with the leptonic decays, where the main hadronic input (meson decay constants) drops out of the LFU ratios. 
...
\begin{figure}[ht]
    ...
    \caption{ Anomaly of lepton flavor universality in the semi-leptonic decays of \PB meson \cite{Amhis:2019ckw}. The world average of $R^{\PB}_{\PD, \PGt/l}$  and $R^{\PB}_{\PD^*, \PGt/l}$  shows a four sigma deviation from the Standard Model prediction.}
