...
% In general, when the coupling constant is small than 1, we expend the running of couplings $\beta(\alpha)$ with respect to the energy scale $\mu$ by the power series of the couplings itself $\alpha$.
