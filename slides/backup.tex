...
\smaller
    \begin{table}
        ...
        \resizebox{0.95\textwidth}{!}{\input{chapters/Analysis/sectionSelection/tables/objectSelectionSummary}}
    \end{table}
\end{frame}
...
Constituents [\%] of selected signal events.
    \begin{table}
        ...
        \resizebox{0.96\textwidth}{!}{\input{chapters/Analysis/sectionSelection/tables/sigcomp}}
    \end{table}
\end{frame}
...
\begin{frame}{Event Selection extended}
    \begin{table}
        ...
        \setlength{\tabcolsep}{1em}
        \renewcommand{\arraystretch}{2}
        \resizebox{0.99\textwidth}{!}{\input{chapters/Analysis/sectionSelection/tables/yieldsShape1}}
    \end{table}
\end{frame}
...
\begin{frame}{Event Selection extended}
    \begin{table}
        ...
        \setlength{\tabcolsep}{1em}
        \renewcommand{\arraystretch}{2}
        \resizebox{0.99\textwidth}{!}{\input{chapters/Analysis/sectionSelection/tables/yieldsShape2}}
    \end{table}
\end{frame}
