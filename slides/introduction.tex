...
\smaller 
    ...
    \begin{center}
    \resizebox{0.6\textwidth}{!}{\input{slides/figures/feynman_W2lnu}}
    \end{center}
...
\smaller
    \begin{columns}
        ...
        \begin{block}{}
            \centering
            \small{\ttbar} process
            \resizebox{0.98\textwidth}{!}{\input{chapters/Physics/sectionPPCollision/figures/feynman_tt}}
        \end{block}
        % add column
        \column{0.4\textwidth}
        \begin{block}{}
            \centering
            \small{\tW} process
            \resizebox{0.98\textwidth}{!}{\input{chapters/Physics/sectionPPCollision/figures/feynman_tW}}
        \end{block}
    \end{columns}
